...
@Component({
  selector: 'app-dynamic-ellipse',
  templateUrl: './dynamic-ellipse.component.html',
  styleUrls: ['./dynamic-ellipse.component.css'],
})
export class DynamicEllipseComponent implements OnInit, OnDestroy {
  translateAttribute = ``;
  viewableAreaWidth = 0;
